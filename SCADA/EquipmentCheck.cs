        ...
        public EquipmentCheck()
        {
            ...
            lock (CheckdataGridView_DBCLock)
            {
                ...
                for (int ii = 0; ii < CNCSUM; ii++)//CNC
                {
                    ...
                    rowstr[(int)CheckdataGridView_titleArr_Index.设备编码] = MainForm.m_xml.m_Read(m_xmlDociment.PathRoot_CNC, ii, m_xmlDociment.Default_Attributes_str1[(int)m_xmlDociment.Attributes_str1.EQUIP_CODE]);
            ...
            //202108StateChageEvenHandle = new EventHandler<ScadaHncData.EQUIP_STATE>(this.EquipMentSateShangeFuc);
...
//             if (MainForm.m_xml.m_Read(m_xmlDociment.PathRoot_PLC, 0, m_xmlDociment.Default_Attributes_str1[(int)m_xmlDociment.Attributes_str1.system]) == m_xmlDociment.PLC_System[0])//三菱
        ...
        //                    CheckdataGridView_DB.Rows[MainForm.cnclist.Count][(int)CheckdataGridView_titleArr_Index.状态];
        //            }
        //        }
        //    }
        //    CheckdataGridView_DB_ChangeFlg = true;
